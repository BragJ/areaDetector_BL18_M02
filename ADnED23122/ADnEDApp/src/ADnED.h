...
#define ADnEDHdfFileNumberParamString  "ADNED_HDF_FILE_NUMBER"
...
class ADnED : public ADDriver {
 ...
 public:
  ...
  int file_num,group_num,pixel_num,tof_num;
  char nexus_file_name[100],single_hdf_file_name[100],group_name[100],data_name[100],pixel_name[100],tof_name[100];
  NXhandle file_id,clone_fileid;
  NXstatus nxstat;
  #define MAX_FILENAME_LEN 256
  char hdfFullFileName[MAX_FILENAME_LEN];
  char hdfFileTemplate[MAX_FILENAME_LEN];
  int hdfFileWriteMode;
  epicsUInt32 hdfFileNumber;
